    ...
    try {
        ...
        const choiceList: ChoiceList = {
            choices: [
                ...
                { seed: 4, team: 'Virginia Tech', region: 'east', eliminated: true, winningRounds: [64, 32] },
                ...
                { seed: 3, team: 'LSU', region: 'east', eliminated: true, winningRounds: [64, 32] },
                ...
                { seed: 2, team: 'Michigan State', region: 'east', eliminated: true, winningRounds: [64, 32, 16, 8] },
                ...
                { seed: 3, team: 'Texas Tech', region: 'west', eliminated: false, winningRounds: [64, 32, 16, 8, 4] },
                ...
                { seed: 2, team: 'Michigan', region: 'west', eliminated: true, winningRounds: [64, 32] },
                { seed: 15, team: 'Montana', region: 'west', eliminated: true, winningRounds: [] },

                { seed: 1, team: 'Virginia', region: 'south', eliminated: false, winningRounds: [64, 32, 16, 8, 4] },
                ...
                { seed: 12, team: 'Oregon', region: 'south', eliminated: true, winningRounds: [64, 32] },
                ...
                { seed: 3, team: 'Purdue', region: 'south', eliminated: true, winningRounds: [64, 32, 16] },
                ...
                { seed: 2, team: 'Tennessee', region: 'south', eliminated: true, winningRounds: [64, 32] },
                { seed: 15, team: 'Colgate', region: 'south', eliminated: true, winningRounds: [] },

                { seed: 1, team: 'North Carolina', region: 'midwest', eliminated: true, winningRounds: [64, 32] },
                ...
                { seed: 5, team: 'Auburn', region: 'midwest', eliminated: true, winningRounds: [64, 32, 16, 8] },
                ...
                { seed: 3, team: 'Houston', region: 'midwest', eliminated: true, winningRounds: [64, 32] },
