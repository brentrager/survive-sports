    ...
    try {
        ...
        const choiceList: ChoiceList = {
            choices: [
                ...
                { seed: 3, team: 'Texas Tech', region: 'west', eliminated: false, winningRounds: [64, 32, 16, 8] },
                ...
                { seed: 1, team: 'Virginia', region: 'south', eliminated: false, winningRounds: [64, 32, 16, 8] },
