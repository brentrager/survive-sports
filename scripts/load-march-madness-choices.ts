...
(async () => {
    ...
    const choiceList: ChoiceList = {
        choices: [
            ...
            { seed: 11, team: 'Belmont / Temple', region: 'east', eliminated: false },
            { seed: 3, team: 'LSU', region: 'east', eliminated: false },
            { seed: 14, team: 'Yale', region: 'east', eliminated: false },
            { seed: 7, team: 'Louisville', region: 'east', eliminated: false },
            { seed: 10, team: 'Minnesota', region: 'east', eliminated: false },
            { seed: 2, team: 'Michigan State', region: 'east', eliminated: false },
            { seed: 15, team: 'Bradley', region: 'east', eliminated: false },
            ...
            { seed: 12, team: 'New Mexico State', region: 'midwest', eliminated: false },
            { seed: 4, team: 'Kansas', region: 'midwest', eliminated: false },
            { seed: 13, team: 'Northeastern', region: 'midwest', eliminated: false },
    ...
    await ChoiceListModel.findOneAndUpdate({}, choiceList, { new: true }).exec();
